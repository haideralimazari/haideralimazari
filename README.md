...
![Semgrep](https://img.shields.io/badge/Semgrep-4A90D9?style=for-the-badge&logo=semgrep&logoColor=white)
...
### 🤖 AI & Agentic Workflows *(Exploring)*
...
📁 agentic-devops-bot/ [WIP]
   └─ LangChain + Strands Agents
   └─ LLM-powered ops automation workflows
```

*👉 Check pinned repos below for code & details!*
...
```
[→] CKA exam prep — Advanced Kubernetes
[→] Strands AI Agents for DevOps automation
[→] AWS Solutions Architect concepts
[→] Multi-cloud Terraform module design
```
...
```
┌──────────────────────────────────────────────────────────┐
│  "Started with curiosity. Ended up automating            │
│   everything."                                           │
└──────────────────────────────────────────────────────────┘
```
